...
<body>
 ...
 <?php require_once "../parts/user_controller/home_search.php"; ?>
  ...
  <form method="POST" action="<?php htmlspecialchars("PHP_SELF"); ?>">
  	 <div class="row">
  	 	<div class="col-md-5">
  	 		  <?php require_once "../parts/user_controller/product_image.php"; ?>
  	 	</div><!-- end of col-md-4 -->
        <div class="col-md-6">
          ...
          <div id="product_price">
           ...
           <div class="row">
            ...
            <div class="col-md-9">
                ...
                <?php 
                  $customer_id =  $userdeatails['user_id'];
                  $customerFName =  $userdeatails['firstname'];
                  $customerFLName =  $userdeatails['Lastname'];
                  $custmer_address =  $userdeatails['address'];
                  $custmer_number =  $userdeatails['contact_number'];
                    ...
                    <div class='col-md-12 mt-2 d-flex'>
                      <label class='me-2 mt-2'>Quantity</label>
                       <input type='number'name='qty'  class='form-control text-center me-2 ' data-min='0' placeholder='Input Quantity' required value='1'>
                        ...
                        <input type='hidden' name='customer_name' value='$customerFName $customerFLName'>
                        ...
                        <input type='hidden' name='address' value='$custmer_address'>
                        <input type='hidden' name='contact_number' value='$custmer_number'>
