...
<body>
 ...
 <?php require_once "../parts/user_controller/home_nav.php"; ?>
  ...
  <div class="container text-center mt-3" id="change_name">
   ...
   <form method="POST" action="update/process_updataddress.php">
     <div class="row">
     <div class="col-md-3"></div>
      <div class="col-md-6">
           <input type="hidden" name="user_id" value="<?= $userdeatails['user_id'];?>">
         <div class="form-floating">
             <input type="text" name="new_address" class="form-control" value="<?= $userdeatails['address'];?>" required>
               <label for="floatingInput">Change Address</label>
