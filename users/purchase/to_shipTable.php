 <div class="row">
      <?php 
       ...
       ?>
        <div class="col-md-12">
           <?php $view_product = mysqli_query($conn, "SELECT * FROM tbl_buying where user_id='$customerID' and status='toship'"); ?>
          <table class="table">
         <thead>
             <div class="d-flex">
                 <h5 class="text-uppercase me-1">To</h5>
                 <h5 class="text-uppercase text-success">Ship</h5>
              </div>
           <tr>
             <th>Product</th>
              <th>Unit Price</th>
 ...
 <tbody>
    ...
    $view_totalSale = mysqli_query($conn, "SELECT user_id, SUM(price*qty+shipping_fee) as total_sale FROM tbl_buying WHERE user_id='$user_id' and status='toship'"); ?>
