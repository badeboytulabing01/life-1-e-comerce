 <div class="row">
      <?php 
       ...
       ?>
        <div class="col-md-12">
           <?php $view_product = mysqli_query($conn, "SELECT * FROM tbl_buying where user_id='$customerID' and status='cancel' "); ?>
          <table class="table" id="category">
         <thead>
             <div class="d-flex">
                 <h5 class="text-uppercase me-1">Cancel</h5>
                 <h5 class="text-uppercase text-success">Orders</h5>
              </div>
           <tr>
             <th>Product</th>
              <th>Unit Price</th>
