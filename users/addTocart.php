 ...
 <?php require_once "../parts/user_controller/home_search.php"; ?>
   <div class="container mt-2" id="buy_now">
      ...
      <?php 
       ...
       ?>
        <div class="col-md-12">
           <?php $view_product = mysqli_query($conn, "SELECT * FROM tbl_buying where status='addTocart' and user_id='$customerID'"); ?>
          <table class="table">
         <thead>
           <tr>
             <th>Product</th>
    ...
    $view_totalSale = mysqli_query($conn, "SELECT status, user_id, SUM(price*qty+shipping_fee) as total_sale FROM tbl_buying WHERE user_id='$user_id' AND  status='addTocart'"); ?>
...
<br><br><br><br>
 <?php require_once "delete/cancel_delete.php" ?>
 <?php 
