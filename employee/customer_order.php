      ...
      <div class="row">
       <div class="col-md-12">
        ...
        <?php $employee_id = $userdeatails['user_id'];?>
         <?php $view_orders = mysqli_query($conn, "SELECT DISTINCT user_id, customer_name, address, mobile_number FROM `tbl_buying` WHERE status='Delivery' and employee_id='$employee_id' "); ?>
           ...
           <?php while ($row = mysqli_fetch_assoc($view_orders)):
              ...
              <tr>
                 ...
                 <td>
                   ...
                   <div class="d-flex">
                    <?php echo "<a href='view_orders.php?user_id=$user_id'
