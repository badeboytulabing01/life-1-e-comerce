...
<div class="col py-3">
      ...
      <div class="row">
            ...
            <?php $view_orders = mysqli_query($conn, "SELECT * FROM `tbl_buying` WHERE status='Delivery' and user_id='$custmer_id' and employee_id='$employee_id' "); ?>
    ...
    $view_totalSale = mysqli_query($conn, "SELECT user_id, SUM(price*qty+shipping_fee) as total_sale FROM tbl_buying WHERE status='Delivery' and user_id='$custmer_id' and employee_id='$employee_id' "); ?>
   ...
   <div class="col-md-12 mt-4">
         <a href="customer_order.php" class="btn btn-danger">Back <i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a>
