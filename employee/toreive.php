...
<div class="col py-3">
      ...
      <div class="row">
       <div class="col-md-12">
         ...
         <?php $view_orders = mysqli_query($conn, "SELECT DISTINCT user_id, customer_name, address, mobile_number FROM `tbl_buying` WHERE status='toreceive'"); ?>
         <h5 class="mt-2 fw-bold text-center">TO RECEIVE</h5>
         <table id="category" class="table table-responsive" cellspacing="0" width="100%">
           ...
           <?php while ($row = mysqli_fetch_assoc($view_orders)):
              ...
              <tr>
                 ...
                 <td>
                   <form action="toreive.php" method="POST">
                    <input type="hidden" name="user_id" value="<?php echo $row['user_id'];?>">
                   <div class="d-flex">
                    <?php echo "<a href='torecieveview_orders.php?user_id=$user_id'
 ...
 <?php require_once "update_delete/torecievedelete.php";?>
