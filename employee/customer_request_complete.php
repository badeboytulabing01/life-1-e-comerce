...
<div class="col py-3">
      ...
      <div class="row">
       <div class="col-md-12">
         ...
         <?php $view_orders = mysqli_query($conn, "SELECT DISTINCT email, user_id, full_name, contact, address FROM `tbl_request` WHERE status='complete' and employee_id='$employee_id'"); ?>
          <h4 class="text-center text-danger fw-bold">Complete Request</h4>
               ...
               <td>
                   ...
                   class='btn btn-outline-primary me-1'><i class='fa fa-eye' aria-hidden='true'></i> View Request</a>"; ?>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      <li><button type="submit" name="pending" id="pending" class="dropdown-item">Process</button></li>
                   </ul>
                </div>
